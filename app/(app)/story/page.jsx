...
export default function StoryPage() {
  ...
  if (!data?.chapter) {
    return (
      <div>
        ...
        >
          Belum ada bab story aktif. Jalankan seed{" "}
          <code style={{ color: C.glow2 }}>supabase/seed/story_chapter1.sql</code>{" "}
  ...
  const { chapter, missions, chapter_complete } = data;
  ...
  return (
    <div>
      <SectionTitle
        ...
        subtitle={`Bab ${chapter.chapter_number} · ${chapter.judul}`}
      />
        ...
        {missions.map((mission) => {
          ...
          return (
            <div
              ...
              style={{
                background: C.deep2,
                border: `1px solid ${mission.status === "completed" ? C.glow2 : C.line}`,
                borderRadius: 14,
                padding: 14,
